...
permalink: /framework/2.0/en/cli/
previous_page: Session
previous_page_url: /framework/2.0/en/session/
next_page: Setting up Virtual Host
next_page_url: /framework/2.0/en/setup/
---
...
The dependency injection _Container_ is absolutely central to the operation of an aura framework project. Please be familiar with [the DI docs](/framework/2.0/en/di/) before continuing.

You should also familiarize yourself with [Dispatching](/framework/2.0/en/dispatching/), as well as the Aura.Cli _Context_, _Stdio_, and _Status_ objects.

## Project Configuration

Every Aura project is configured the same way. Please see the [shared configuration docs](/framework/2.0/en/configuration/) for more information.
