...
next_page_url: /framework/2.x/en/configuration
---
...
The `web/index.php` is where you need to point your virtual host. Check out [setting up your virtual host](/framework/2.x/en/setup/) for more information.
